...
public class State
{
	...
	/**
	 * Record of the agents and principals in the society. All the links between
	 * these (i.e. opinions) are stored in the agent objects.
	 */
	 ...
	 * @param assignments
	 */
	public State(List<Agent> agents, List<Agent> trustors, List<List<Agent>> teams,
			Map<Agent, List<Agent>> assignments, Map<Agent, Agent> interactors)
	{
		// essentially make a copy of the whole state - this is what he'd have
		// been doing in
		// the file anyway...
